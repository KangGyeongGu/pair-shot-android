package com.pairshot.feature.export.data.repository
...
import com.pairshot.feature.export.data.service.ExportEntryFactory
import com.pairshot.feature.export.data.service.ShareImagePreparer
import com.pairshot.feature.export.data.service.WatermarkedBitmapWriter
import com.pairshot.feature.export.data.service.WatermarkedZipTask
            ...
            try {
                galleryEntries.forEachIndexed { index, entry ->
                    if (watermarkConfig != null && !entry.isCombined && entry.sourceUri.isNotBlank()) {
                        ...
                        // WatermarkRenderer is accessed via WatermarkedBitmapWriter — use temp file approach

...
<img src="./design/icon/ic_readme.png" alt="PairShot" width="120" style="border-radius: 24px;" />
...
![Coil](https://img.shields.io/badge/Coil_3.4.0-FF6600?style=for-the-badge&logoColor=white)
...
#### 이미지 합성
선택한 Before·After 페어 원본을 합성하여 단일 비교 이미지를 생성합니다. 원본 비트맵 기반으로 합성하여 이중 압축 없이 원본 화질을 유지합니다.
